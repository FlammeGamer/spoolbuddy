...
extern const lv_img_dsc_t img_amssetup;
extern const lv_img_dsc_t img_spool;
...
extern const lv_img_dsc_t img_circle;
extern const lv_img_dsc_t img_circle_dotted;
